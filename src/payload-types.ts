...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "SplitTextHeroBlock".
 */
export interface SplitTextHeroBlock {
  /**
   * Background image for the hero section
   */
  backgroundImage: string | Media;
  /**
   * Small uppercase text above the main heading (e.g., "ABOUT")
   */
  subheading?: string | null;
  /**
   * Main text that will be displayed in white color
   */
  primaryText: string;
  /**
   * Secondary text that will be displayed in gray color
   */
  secondaryText?: string | null;
  /**
   * Delay between each letter animation in milliseconds (default: 30ms)
   */
  animationSpeed?: number | null;
  /**
   * Apply gradient effect to primary text
   */
  enableGradient?: boolean | null;
  id?: string | null;
  blockName?: string | null;
  blockType: 'splitTextHero';
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CaseStudySectionBlock".
 */
export interface CaseStudySectionBlock {
  /**
   * Main section title (e.g., "Selected Work", "Our Projects")
   */
  title: string;
  /**
   * Add case studies to display in this section
   */
  caseStudies: {
    /**
     * Case study title
    ...
    /**
     * Main image for the case study card
     */
    image: string | Media;
    /**
     * Optional video that plays on hover (MP4 format recommended)
     */
    video?: (string | null) | Media;
    /**
     * Choose whether to link to an internal page or use a custom URL
     */
    ...
    /**
     * Enter a custom URL (e.g., /case-studies/project-name)
     */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "FullScreenVideoBlock".
 */
export interface FullScreenVideoBlock {
  columns?:
    | {
        richText?: {
          root: {
  ...
  id?: string | null;
  blockName?: string | null;
  blockType: 'fullScreenVideo';
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ImpactSectionBlock".
 */
export interface ImpactSectionBlock {
  columns?:
    | {
        richText?: {
          root: {
  ...
  id?: string | null;
  blockName?: string | null;
  blockType: 'impactSection';
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ReadingTextBlock".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ServicesSection2Block".
 */
export interface ServicesSection2Block {
  columns?:
    | {
        richText?: {
          root: {
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        splitTextHero?: T | SplitTextHeroBlockSelect<T>;
        caseStudySection?: T | CaseStudySectionBlockSelect<T>;
        ...
        fullScreenVideo?: T | FullScreenVideoBlockSelect<T>;
        impactSection?: T | ImpactSectionBlockSelect<T>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "SplitTextHeroBlock_select".
 */
export interface SplitTextHeroBlockSelect<T extends boolean = true> {
  backgroundImage?: T;
  subheading?: T;
  primaryText?: T;
  secondaryText?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CaseStudySectionBlock_select".
 */
export interface CaseStudySectionBlockSelect<T extends boolean = true> {
  title?: T;
  caseStudies?:
    | T
    | {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "FullScreenVideoBlock_select".
 */
export interface FullScreenVideoBlockSelect<T extends boolean = true> {
  columns?:
    | T
    | {
        richText?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ImpactSectionBlock_select".
 */
export interface ImpactSectionBlockSelect<T extends boolean = true> {
  columns?:
    | T
    | {
        richText?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ReadingTextBlock_select".
 */
export interface ReadingTextBlockSelect<T extends boolean = true> {
  columns?:
    | T
    | {
        richText?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ServicesSection2Block_select".
 */
export interface ServicesSection2BlockSelect<T extends boolean = true> {
  columns?:
    | T
    | {
        richText?: T;
